...
train_data, train_line, train_label = data.get_pad_data("DataSet/train_zhuyin.json")
test_data, test_line, test_label = data.get_pad_data("DataSet/test_zhuyin.json")
